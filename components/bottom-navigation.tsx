      ...
      <div className="max-w-[430px] mx-auto">
        <div className="flex justify-around items-center px-4 pb-[calc(0.65rem+env(safe-area-inset-bottom))] pt-2">
          ...
          >
            ...
            <span className="mt-1 text-center text-[16px] font-normal">Home</span>
          </Link>
          <Link
            href="/scan-qr"
            className={`flex flex-col items-center justify-center p-2 min-w-[60px] transition-colors duration-200 ${
          ...
          >
            ...
            <span className="mt-1 text-center text-[16px] font-normal">Scan QR</span>
          </Link>
          <Link
            href="/inbox"
            className={`flex flex-col items-center justify-center p-2 min-w-[60px] transition-colors duration-200 ${
          ...
          >
            ...
            <span className="mt-1 text-center text-[16px] font-normal">Inbox</span>
          </Link>
        </div>
      </div>
    </div>
