...
export default function AppPage() {
  ...
  const FeatureButton = ({
    ...
    return (
      ...
      >
        ...
        <div className="text-center text-[14px] font-normal leading-tight text-[#000000]">{title}</div>
      </Link>
    )
  }
  ...
  <button type="button" onClick={toggleBalance} className="absolute left-[7.25rem] right-0 top-[3.5rem] whitespace-nowrap text-left text-[clamp(1.15rem,7vw,2.25rem)] font-semibold tracking-normal text-[#142033]" aria-label="Toggle balance">
