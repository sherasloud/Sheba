...
export default function AppPage() {
  ...
  <button type="button" onClick={toggleBalance} className="absolute left-[7.25rem] right-0 top-[3.5rem] whitespace-nowrap text-left text-[clamp(1.15rem,7vw,2.25rem)] font-normal tracking-normal text-[#142033]" aria-label="Toggle balance">
