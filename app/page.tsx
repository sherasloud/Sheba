  ...
  const FeatureButton = ({
    ...
    return (
      ...
      >
        ...
        <div className="text-center text-base font-normal leading-tight">{title}</div>
      </Link>
    )
  }
    ...
    >
      ...
      <header className="bg-white px-5 pb-2 pt-3">
        <div className="flex items-center justify-between">
          <div className="w-10" />
          <img src="/images/sheba-headline-logo.jpeg" alt="সেবা" className="h-10 w-auto object-contain" />
