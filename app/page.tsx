...
export default function AppPage() {
  ...
  <button type="button" onClick={toggleBalance} className="absolute left-[7.25rem] right-0 top-[3.5rem] whitespace-nowrap text-left text-[clamp(0.9rem,5.5vw,1.75rem)] tracking-[0.08em] text-[#142033]" aria-label="Toggle balance">
