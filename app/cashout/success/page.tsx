  ...
  useEffect(() => {
    ...
    if (amount) {
      const data = {
        ...
        agent,
        reference: reference || `CSH${Date.now()}`,
        date: new Date().toLocaleDateString(),
        time: new Date().toLocaleTimeString(),
      }
      setTransactionData(data)

      // Trigger real notification for cashout
      realNotificationSystem.triggerCashoutNotification(Number.parseInt(amount), agent)
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="bg-[#29a9eb] text-white p-4 flex items-center justify-between">
        ...
        <div className="text-lg font-medium">Cashout Complete</div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Cashout Successful!</h1>
        <p className="text-gray-600 text-center mb-8">Your cashout has been completed successfully</p>

        {/* Transaction Details */}
        <div className="w-full max-w-md bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-lg font-semibold mb-4">Cashout Details</h2>
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold">{transactionData.agent}</span>
            </div>
            <div className="flex justify-between">
