...
export default function MerchantDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (userRole !== "merchant") {
      router.replace("/login") // Redirect if not merchant
    } else {
        ...
        <Card className="mb-4">
          ...
          <CardContent>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <Button className="w-full">Accept Payment</Button>
              <Button className="w-full">Sales History</Button>
              <Button className="w-full">Withdrawal</Button>
